...
public class PartyPlanner extends JFrame implements ActionListener{ //This class has the gui and ability to run the party classes
    ...
    private JButton regParty = new JButton("Normal Party"); //This button chooses opening up the selections for a normal party
    private JButton dinParty = new JButton("Dinner Party"); //This button chooses opening up the selections for a dinner party
    ...
    private void mainPlanner(){
        ...
        mainFrame = new Frame("Party Planner application");
        ...
        msg = new Label("Your planned party is ready in the console!");
    ...
    public void chooseParty(){
        headerLabel.setText("Thank you for choosing our Party Planner! What type of Party are you planning?");
    ...
    public void showRegPartyPlanner(){
        headerLabel.setText("Planning a Regular Party! How many guests are coming? Enter here:");
    ...
    public void showDinPartyPlanner(){
        headerLabel.setText("Planning a Dinner Party! How many guests are coming? Enter here:");
        partyChoice.setVisible(false);
    ...
    public void actionPerformed(ActionEvent e){
        if (e.getSource() == regParty){
            ...
            msg.setVisible(true);
            System.out.println("The party has " + woo.getGuests() + " guests");
            ...
            headerLabel.setVisible(false);
            msg.setVisible(true);
            System.out.println("The dinner party has " + delicious.getGuests() + " guests");
